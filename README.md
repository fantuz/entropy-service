...
- HTTP:  70'000 requests per second (payload 64B) or a throughput up to 1 GB/s (payload 512KB)
- HTTPS: 50'000 requests per second (payload 64B) or a throughput up to 600 MB/s (payload 512KB)
